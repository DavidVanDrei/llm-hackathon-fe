        ...
        {user.email === 'anonymous'
           ? <span className="tooltip tooltip-bottom before:text-xs before:content-[attr(data-tip)]" data-tip="GitHub">
             <div className="flex-none items-center">
               <Link aria-label="Github" target="_blank" href="https://github.com/Kwisatz-Haderach-Lab/llm-hackathon-fe" rel="noopener" className="btn btn-ghost drawer-button btn-square normal-case">
